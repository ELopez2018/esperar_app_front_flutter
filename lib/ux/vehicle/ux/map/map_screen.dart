...
import 'package:esperar_app_front_flutter/ux/widgets/indicator_route.dart';
import 'package:esperar_app_front_flutter/ux/vehicle/ux/map/widgets/vehicle_indicator_route.dart';
            ...
            children: [
              Positioned.fill(
                child: Consumer(builder:(context, value, child) {
                  final currentPosition = layoutBloc.currentPosition;
                  if(currentPosition != null){
                    return GoogleMap(
                  initialCameraPosition:  CameraPosition(
                      target: LatLng(currentPosition.latitude,currentPosition.longitude), zoom: 13.7),
