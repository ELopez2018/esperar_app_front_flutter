...
import 'package:esperar_app_front_flutter/ux/vehicle/ux/select%20driver/select_driver_provider.dart';
                          ...
                          child: Column(
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  PlateVehicle(
                                      plate: bloc.getVehicle()!.licensePlate,
                                      background: Colors.yellow),
                                  const SizedBox(width: 20),
                                  PlateVehicle(
                                      number: int.parse(
                                          bloc.getVehicle()!.secondaryPlate!),
                                  ...
                                  return GestureDetector(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Text(
                                            bloc.users[index].firstName ??
                                                'Admin',
                                            style: TextStyle(
                                                color: bloc.selectUser
                                                    ? Colors.green
                                                    : Colors.black,
                                                fontWeight: bloc.selectUser
                                                    ? FontWeight.bold
                                                    : FontWeight.normal)),
                                        Text(bloc.users[index].documentNumber !=
                                                null
                                            ? bloc.users[index].documentNumber
                                                .toString()
                                            : '1234')
                                      ],
                                    ),
