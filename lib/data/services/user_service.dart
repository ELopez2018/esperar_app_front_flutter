...
import 'package:esperar_app_front_flutter/data/models/users/user_request_model.dart';
...
class UserService {
  ...
  Future<UserModel?> singUp(UserRequestModel user) async {
    try {
      final response = await _dio.post('/users/singup', data: user);
